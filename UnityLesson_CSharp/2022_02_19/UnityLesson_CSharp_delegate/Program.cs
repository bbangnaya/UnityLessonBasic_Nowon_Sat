...
namespace UnityLesson_CSharp_delegate
{
    ...
    {
        delegate void aa(int a, int b);         // delegate타입의 aa (함수아니다.)
                                                // 
        ...
        /*static void PrintCalcResult(int sumResult, int subResult)
        {
            Console.WriteLine($"합 : {sumResult}");
            Console.WriteLine($"차 : {subResult}");
        }*/

        /*static void PrintCalcResult(int a, int b, CalcDelegate sum, CalcDelegate sub)
        {
            Console.WriteLine($"합 : {sum(a,b)}");
            Console.WriteLine($"차 : {sub(a,b)}");
        }*/


        static void PrintCalcResult(int a, int b, CalcDelegate calcMethod)
        {
            Console.WriteLine($"합 : {calcMethod(a, b)}");
        }
    }
}
